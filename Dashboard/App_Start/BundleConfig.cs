...
namespace Dashboard
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // Hilti style
            bundles.Add(new StyleBundle("~/bundles/hilti/css").Include(
                      "~/Content/hilti.css", new CssRewriteUrlTransform()));
            ...
            // Morris style
            bundles.Add(new StyleBundle("~/bundles/morris/css").Include(
                      "~/Vendor/morris/css/morris.css"));

            // Morris
            bundles.Add(new ScriptBundle("~/bundles/morris/js").Include(
                      "~/Vendor/morris/js/raphael-min.js",
                      "~/Vendor/morris/js/morris.min.js"));

            // Timeline style
            bundles.Add(new StyleBundle("~/bundles/timeline/css").Include(
                      "~/Vendor/timeline/timeline.min.css"));

            // Timeline
            bundles.Add(new ScriptBundle("~/bundles/timeline/js").Include(
                      "~/Vendor/timeline/timeline.min.js"));

            // Timeline style
            bundles.Add(new StyleBundle("~/bundles/scroll/css").Include(
                      "~/Vendor/scroll/style.css"));

            // Timeline
            bundles.Add(new ScriptBundle("~/bundles/scroll/js").Include(
                       "~/Vendor/scroll/js/html5shiv.js",
                      "~/Vendor/scroll/js/enscroll-0.4.2.min.js"));

            // loader style
            bundles.Add(new StyleBundle("~/bundles/loader/css").Include(
                "~/Vendor/loader/fakeLoader.css"));

            // loader
            bundles.Add(new ScriptBundle("~/bundles/loader/js").Include(
                "~/Vendor/loader/jquery.loadingModal.js"));

            // floting style
            bundles.Add(new StyleBundle("~/bundles/floating/css").Include(
                "~/Vendor/floating/jquery.floatingscroll.css"));

            // floating
            bundles.Add(new ScriptBundle("~/bundles/floating/js").Include(
                "~/Vendor/floating/jquery.floatingscroll.js"));
            ...
            bundles.Add(new StyleBundle("~/bundles/jqueryui/css").Include(
                ...
                "~/Vendor/jquery-ui/themes/base/datepicker.css"));

            // toggle
            bundles.Add(new ScriptBundle("~/bundles/toggle/js").Include(
                "~/Scripts/bootstrap-toggle.js"));

            // toggle style
            bundles.Add(new StyleBundle("~/bundles/toggle/css").Include(
